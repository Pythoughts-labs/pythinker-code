...
def test_pyinstaller_datas():
    ...
    expected_datas = [
        ...
        ("src/pythinker_code/tools/progress/description.md", "pythinker_code/tools/progress"),
        ("src/pythinker_code/tools/suggest/description.md", "pythinker_code/tools/suggest"),
