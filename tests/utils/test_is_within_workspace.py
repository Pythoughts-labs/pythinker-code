...
def test_within_work_dir():
    ...
    work_dir = HostPath("/home/user/project")
    assert is_within_workspace(HostPath("/home/user/project/src/main.py"), work_dir)
...
def test_outside_work_dir_no_additional():
    ...
    work_dir = HostPath("/home/user/project")
    assert not is_within_workspace(HostPath("/home/user/other/file.py"), work_dir)


def test_within_additional_dir():
    """Path inside an additional dir should be accepted."""
    work_dir = HostPath("/home/user/project")
    additional = [HostPath("/home/user/lib")]
    assert is_within_workspace(HostPath("/home/user/lib/module.py"), work_dir, additional)
...
def test_additional_dir_itself():
    ...
    work_dir = HostPath("/home/user/project")
    additional = [HostPath("/home/user/lib")]
    assert is_within_workspace(HostPath("/home/user/lib"), work_dir, additional)
...
def test_outside_all_dirs():
    ...
    work_dir = HostPath("/home/user/project")
    additional = [HostPath("/home/user/lib")]
    assert not is_within_workspace(HostPath("/tmp/evil"), work_dir, additional)


def test_multiple_additional_dirs():
    """Path within any of multiple additional dirs should be accepted."""
    work_dir = HostPath("/home/user/project")
    additional = [HostPath("/home/user/lib"), HostPath("/opt/shared")]
    assert is_within_workspace(HostPath("/opt/shared/config.json"), work_dir, additional)


def test_prefix_attack_work_dir():
    """Path sharing prefix but not actually inside work_dir should be rejected."""
    work_dir = HostPath("/home/user/project")
    assert not is_within_workspace(HostPath("/home/user/project-evil/hack.py"), work_dir)
...
def test_prefix_attack_additional_dir():
    ...
    work_dir = HostPath("/home/user/project")
    additional = [HostPath("/home/user/lib")]
    assert not is_within_workspace(HostPath("/home/user/lib-evil/hack.py"), work_dir, additional)


def test_empty_additional_dirs():
    """Empty additional_dirs sequence should not cause errors."""
    work_dir = HostPath("/home/user/project")
    assert is_within_workspace(HostPath("/home/user/project/a.py"), work_dir, [])
    assert not is_within_workspace(HostPath("/tmp/x"), work_dir, [])
...
def test_is_within_directory_prefix_attack():
    ...
    assert not is_within_directory(
        HostPath("/home/user/project-evil"), HostPath("/home/user/project")
    )
    assert is_within_directory(HostPath("/home/user/project/sub"), HostPath("/home/user/project"))
...
def test_is_within_workspace_uses_relative_to_not_string_ops():
    ...
    work_dir = HostPath("/app")
    additional = [HostPath("/app-data")]

    # /app-data is an additional dir, so paths inside it should pass
    assert is_within_workspace(HostPath("/app-data/file.txt"), work_dir, additional)

    # /app-data-evil shares prefix with /app-data but is not inside it
    assert not is_within_workspace(HostPath("/app-data-evil/file.txt"), work_dir, additional)
