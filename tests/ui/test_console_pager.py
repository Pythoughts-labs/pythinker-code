...
from pythinker_code.ui.shell.console import _PythinkerPager, console
...
class TestConsolePagerIgnoresManpager:
    ...
    def test_pager_context_uses_pythinker_pager_by_default(self):
    ...
    def test_manpager_stripped_during_pydoc_pager(self):
        """When MANPAGER is set, _PythinkerPager must strip it before calling pydoc.pager()."""
