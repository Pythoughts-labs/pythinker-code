...
from pythinker_core.message import ContentPart, ImageURLPart, Message, TextPart, ToolCall
from pythinker_core.tooling import CallableTool2, Tool, ToolResult, ToolReturnValue, Toolset
...
async def _run_and_collect_turns(
    soul: PythinkerSoul, user_input: str | list[ContentPart]
