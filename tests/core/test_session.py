...
from pythinker_code.wire.file import WireFileMetadata, WireMessageRecord
...
async def test_create_sets_fallback_title(isolated_share_dir: Path, work_dir: HostPath):
    session = await Session.create(work_dir)
    assert session.title == "Untitled"
    assert session.context_file.exists()


async def test_find_uses_wire_title(isolated_share_dir: Path, work_dir: HostPath):
    session = await Session.create(work_dir)
...
async def test_list_sorts_by_updated_and_titles(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_continue_without_last_returns_none(isolated_share_dir: Path, work_dir: HostPath):
    result = await Session.continue_(work_dir)
    assert result is None


async def test_list_ignores_empty_sessions(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_create_named_session(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_custom_title_overrides_wire_title(isolated_share_dir: Path, work_dir: HostPath):
    """custom_title in SessionState takes precedence over wire-derived title."""
    from pythinker_code.session_state import save_session_state
...
async def test_custom_title_makes_session_non_empty(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_custom_title_persists_across_find(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_save_state_preserves_external_title(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_save_state_preserves_external_archive(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_title_never_contains_session_id(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_list_titles_are_pure(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_refresh_without_wire_or_custom_title(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_save_state_preserves_in_memory_todos(isolated_share_dir: Path, work_dir: HostPath):
    """save_state() should persist in-memory todos (worker-owned) to disk."""
    from pythinker_code.session_state import TodoItemState, load_session_state
...
async def test_new_does_not_delete_titled_session(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_post_run_empty_session_success(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_post_run_empty_session_failure(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_post_run_nonempty_session_success(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_post_run_nonempty_session_failure(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_reload_source_session_attribute(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_reload_cleanup_deletes_empty_source(isolated_share_dir: Path, work_dir: HostPath):
...
async def test_reload_same_session_not_deleted(isolated_share_dir: Path, work_dir: HostPath):
