{
  description = "pythinker-code flake";
  inputs = {
          ...
          pythinker-code =
            let
              ...
              extraBuildOverlay = final: prev: {
                ...
                "pythinker-code" = prev."pythinker-code".overrideAttrs (old: {
              ...
              pythinkerCodePackage = pythonSet.mkVirtualEnv "pythinker-code-virtual-env-${pyproject.project.version}" workspace.deps.default;
            in
            stdenvNoCC.mkDerivation ({
              ...
              meta = {
                description = "Pythinker CLI is a new CLI agent that can help you with your software development tasks and terminal operations";
