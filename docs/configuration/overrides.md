...
| `-y, --yolo` | Start in Ask When Needed mode: routine actions run automatically; risky actions, questions, and plans still ask |
| `--auto` | Start in Never Ask mode: actions and decisions run without asking |
