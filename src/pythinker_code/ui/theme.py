...
_PROMPT_STYLE_DARK = {
    ...
    "compact-input": "",
    "compact-input.prompt": "fg:#7dd3fc bold",
    ...
    "slash-completion-menu.marker.current": "fg:#7dd3fc bold",
    "slash-completion-menu.command": "fg:#a6adba",
    "slash-completion-menu.command.match": "fg:#7dd3fc bold",
    "slash-completion-menu.meta": "fg:#7c8594",
    "slash-completion-menu.command.current": "bg:#3a3a4a fg:#7dd3fc bold",
    "slash-completion-menu.command.match.current": "bg:#3a3a4a fg:#7dd3fc bold",
