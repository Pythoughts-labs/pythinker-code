    ...
    return PTKStyle.from_dict(
        {
            ...
            "frame.border": "#155e75",
            "frame.label": "bg:#0f172a #BAC4FD bold",
            "footer": "bg:#0f172a #cbd5e1",
            "footer.key": "bg:#0f172a #BAC4FD bold",
...
_PROMPT_STYLE_DARK = {
    ...
    "slash-completion-menu.command.current": "bg:#3a3a4a fg:#BAC4FD bold",
    "slash-completion-menu.command.match.current": "bg:#3a3a4a fg:#BAC4FD bold",
    ...
    "shell-dialog.option.current": "bg:#1f2937 fg:#BAC4FD bold",
