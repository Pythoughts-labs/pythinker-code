...
from pythinker_code.wire.types import ContentPart, MCPStatusSnapshot, WireMessage
...
class StatusSnapshot:
    ...
    """Whether the explicit YOLO (dangerously skip permissions) flag is on. Independent of auto."""
    auto_enabled: bool = False
    """Whether auto mode (no user present) is active. Implies auto-approve."""
...
async def _deliver_notifications_to_wire_once(runtime: Runtime | None, wire: Wire) -> None:
    ...
    from pythinker_code.notifications import NotificationView, to_wire_notification
