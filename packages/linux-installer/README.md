...
```sh
# Debian / Ubuntu
curl -LO https://github.com/Pythoughts-labs/pythinker-code/releases/download/v0.40.1/pythinker-code_0.40.1_amd64.deb
curl -LO https://github.com/Pythoughts-labs/pythinker-code/releases/download/v0.40.1/pythinker-code_0.40.1_amd64.deb.sha256
sha256sum -c pythinker-code_0.40.1_amd64.deb.sha256
...
```sh
bash packages/linux-installer/build.sh 0.40.1
```

Outputs to `dist/`:

- `pythinker-code_0.40.1_amd64.deb`
- `pythinker-code-0.40.1.x86_64.rpm`
...
target-triple naming (e.g. `pythinker-0.40.1-x86_64-unknown-linux-gnu.tar.gz`).
