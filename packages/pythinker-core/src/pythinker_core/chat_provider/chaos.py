...
class ChaosChatProvider:
    ...
    def for_pythinker(
        ...
        """Helper to wrap a Pythinker provider without changing caller sites."""
        from pythinker_core.chat_provider.pythinker import Pythinker

        return cls(Pythinker(**kwargs), chaos_config=chaos_config)
...
class ChaosStreamedMessage:
    ...
    def finish_reason(self) -> str | None:
        return self._wrapped.finish_reason
